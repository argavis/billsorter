...
export const STATIC_PROVIDERS: ProviderPreset[] = [
  ...
  { id: 'outlook-imap', label: 'Outlook (eigener Mailserver)', imapHost: null, imapPort: 993, helpUrl: 'https://billsorter.app/how-to-connect', requiresAppPassword: false },
  ...
  { id: 'custom-imap', label: 'Custom IMAP', imapHost: null, imapPort: 993, helpUrl: 'https://billsorter.app/how-to-connect', requiresAppPassword: false },
];
